...
from fastvideo.src.worker.npu_worker import run_worker_process
from loguru import logger


class MultiprocExecutor(Executor):
    def _init_executor(self) -> None:
        self.world_size = self.fastvideo_args.num_npus
        ...
        logger.info("{} workers ready", self.world_size)
    ...
    def set_lora_adapter(self, lora_nickname: str, lora_path: Optional[str] = None) -> None:
        responses = self.collective_rpc(
            "set_lora_adapter", kwargs={"lora_nickname": lora_nickname, "lora_path": lora_path}
        )
