...
from fastvideo.src.configs.models import DiTConfig, EncoderConfig, VAEConfig
from fastvideo.src.configs.models.dits import HunyuanVideoConfig
from fastvideo.src.configs.models.encoders import BaseEncoderOutput, CLIPTextConfig, LlamaConfig
from fastvideo.src.configs.models.vaes import HunyuanVAEConfig
from fastvideo.src.configs.pipelines.base import PipelineConfig
...
def llama_postprocess_text(outputs: BaseEncoderOutput) -> Tensor:
    hidden_state_skip_layer = 2
    assert outputs.hidden_states is not None
    hidden_states: tuple[Tensor, ...] = outputs.hidden_states
    last_hidden_state: Tensor = hidden_states[-(hidden_state_skip_layer + 1)]
...
def clip_postprocess_text(outputs: BaseEncoderOutput) -> Tensor:
    pooler_output: Tensor = outputs.pooler_output
