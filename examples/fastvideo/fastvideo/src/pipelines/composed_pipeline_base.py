...
from fastvideo.src.distributed import maybe_init_distributed_environment_and_model_parallel
from fastvideo.src.entrypoints.args import FastVideoArgs, TrainingArgs
from fastvideo.src.models.loader.component_loader import PipelineComponentLoader
from fastvideo.src.pipelines.batch_info import ForwardBatch
from fastvideo.src.pipelines.stages import PipelineStage
...
class ComposedPipelineBase(ABC):
    ...
    def __init__(
        ...
        loaded_modules: Optional[dict[str, nn.Cell]] = None,
    ):
        """
    ...
    def load_modules(
        self, fastvideo_args: FastVideoArgs, loaded_modules: Optional[dict[str, nn.Cell]] = None
    ) -> dict[str, Any]:
        """
