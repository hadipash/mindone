...
def parse_train_args(parser):
    ...
    parser.add_argument("--use_parallel", default=False, type=str2bool, help="Train in Data Parallel mode.")
    parser.add_argument("--distributed_seq", default=False, type=str2bool, help="Train in Sequence Parallel mode.")
