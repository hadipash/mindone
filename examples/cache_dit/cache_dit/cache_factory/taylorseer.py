...
class TaylorSeer:
    def __init__(self, n_derivatives=2, max_warmup_steps=1, skip_interval_steps=1, compute_step_map=None):
    ...
    def should_compute_full(self, step=None):
        ...
        if step < self.max_warmup_steps or (step - self.max_warmup_steps + 1) % self.skip_interval_steps == 0:
            return True
        return False
